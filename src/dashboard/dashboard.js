...
import { ENDPOINT, SECTIONTYPE, logout,setItemInLocalStorage, getItemFromLocalStorage, LOADED_TRACKS } from "../common";
let displayName;
...
const loadPlaylist =async( endpoint, elementId )=>{
    ...
    for (let {name, description, images, id} of items){
        ...
        <h3 class="text-base font-semibold mb-4 truncate">${name}</h3>
...
const fillContentForDashboard=()=>{
    ...
    <section id=${id} class=" grid grid-cols-auto-fill-cards gap-4">
    </section>
    </article>`
...
const fillContentForPlaylist= async (playlistId)=>{
    ...
    <section id="tracks" class="px-8 mt-4" text-secondary></section> `;
    console.log(playlist);
